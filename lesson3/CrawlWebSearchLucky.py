...
def quick_sort(items):
    ...
    items[:] = lower + [items[pivot]] + upper

def quick_sort_index(pages, items):
    if not pages or len(items) <= 1:
        return pages
    else:
        pivot = items[pages[0]]
        lower, upper = [], []
        ...
        return quick_sort_index(upper, items) + [pages[0]] + quick_sort_index(lower, items)
...
import pprint as pp
pp.pprint(ordered_search(index, ranks, 'Hummus'))
#>>> ['http://udacity.com/cs101x/urank/kathleen.html',
#    'http://udacity.com/cs101x/urank/nickel.html',
...
pp.pprint(ordered_search(index, ranks, 'the'))
#>>> ['http://udacity.com/cs101x/urank/nickel.html',
#    'http://udacity.com/cs101x/urank/arsenic.html',
#    'http://udacity.com/cs101x/urank/hummus.html',
#    'http://udacity.com/cs101x/urank/index.html']
...
pp.pprint(ordered_search(index, ranks, 'babaganoush'))
#>>> None
